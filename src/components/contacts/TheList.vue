  ...
  <div class="contacts__list">
    <div class="contacts__card">
      <div class="contacts__street">
        <div class="contacts__name">Пермякова, 82</div>
        <a href="#" class="contacts__route">маршрут</a>
      </div>
      <div class="contacts__offers">
        ...
        <div class="contacts__hour">
          ...
          <div class="contacts__open">Открыто</div>
        </div>
      </div>
      <div class="contacts__call">
        ...
        <div class="contacts__phone">
          ...
          <a href="tel:+73452546162" class="contacts__calling">Позвонить</a>
        </div>
      </div>
      <div class="contacts__mailto">
        ...
        <div class="contacts__mail">
          ...
          <a href="mailto:dryppa90@gmail.com" class="contacts__write">Написать</a>
        </div>
      </div>
    </div>
    <div class="contacts__card">
